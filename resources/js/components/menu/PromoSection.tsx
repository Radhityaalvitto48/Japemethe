...
export default function PromoSection({ banners }: PromoSectionProps) {
    ...
    const bannerOrigin = typeof window !== 'undefined' && items.length > 0
        ? new URL(items[0].image, window.location.origin).origin
        : null;
    ...
    if (loading) {
        return (
            <section className="px-4 pt-4">
                <div
                    className="aspect-16/7 w-full flex items-center justify-center rounded-xl bg-linear-to-r from-gray-200 to-gray-300"
        ...
        <section className="px-4 pt-4">
            ...
            {bannerOrigin && (
                <>
                    ...
                    <link rel="preconnect" href={bannerOrigin} crossOrigin="anonymous" />
                </>
            )}

            <div className="carousel-container" style={{ containIntrinsicSize: '960px 540px' }}>
                <Carousel
                    autoplay
...
function BannerImage({
    ...
    if (error) {
        return (
            <div className="aspect-16/7 w-full flex items-center justify-center rounded-xl bg-linear-to-r from-orange-400 to-orange-500">
    ...
    return (
        <div
            ...
            style={isPriority ? {
                containIntrinsicSize: '960px 540px',
        ...
        >
            ...
            {!imageLoaded && (
                <div className="absolute inset-0 bg-linear-to-r from-gray-200 via-gray-100 to-gray-200">
            ...
            <img
                ...
                sizes={isPriority ? '100vw' : '(max-width: 768px) 100vw, 720px'}
